...
These images are inspired from the [Instructure Core](https://github.com/instructure/dockerfiles/tree/master/core) images which are used as the base/core image for all [Instructure](https://www.instructure.com/) Docker images. The [`aa8y/core`](https://hub.docker.com/r/aa8y/core/) are less bloated however given the bare-minimum design.
